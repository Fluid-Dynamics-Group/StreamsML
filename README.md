...
- More detailed instructions for modeling, analysis, visualization, and adding new methods are provided in the [detailed user instructions (PDF)](streams/svgs/StreamsMLmanual.pdf).
